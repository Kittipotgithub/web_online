...
@Component({
  selector: 'app-dialog-save-kb',
  templateUrl: './dialog-save-kb.component.html',
  styleUrls: ['./dialog-save-kb.component.scss']
})
export class DialogSaveKbComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogSaveKbComponent>,
